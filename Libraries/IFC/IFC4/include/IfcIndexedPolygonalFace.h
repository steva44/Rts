...
class IFCPP_EXPORT IfcPolygonalFaceSet;
//ENTITY
class IFCPP_EXPORT IfcIndexedPolygonalFace : public IfcTessellatedItem
{ 
public:
	...
	virtual const char* className() const { return "IfcIndexedPolygonalFace"; }
