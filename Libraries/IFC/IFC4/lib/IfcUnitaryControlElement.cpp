...
IfcUnitaryControlElement::IfcUnitaryControlElement( int id ) { m_entity_id = id; }
IfcUnitaryControlElement::~IfcUnitaryControlElement() {}
...
{
	stream << "#" << m_entity_id << "= IFCUNITARYCONTROLELEMENT" << "(";
...
void IfcUnitaryControlElement::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcUnitaryControlElement::toString() const { return L"IfcUnitaryControlElement"; }
void IfcUnitaryControlElement::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcUnitaryControlElement, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcUnitaryControlElementTypeEnum::createObjectFromSTEP( args[8], map );
}
