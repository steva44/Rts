...
IfcCableFitting::IfcCableFitting( int id ) { m_entity_id = id; }
IfcCableFitting::~IfcCableFitting() {}
...
{
	stream << "#" << m_entity_id << "= IFCCABLEFITTING" << "(";
...
void IfcCableFitting::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcCableFitting::toString() const { return L"IfcCableFitting"; }
void IfcCableFitting::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcCableFitting, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcCableFittingTypeEnum::createObjectFromSTEP( args[8], map );
}
