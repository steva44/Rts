...
IfcBuildingElementPartType::IfcBuildingElementPartType( int id ) { m_entity_id = id; }
IfcBuildingElementPartType::~IfcBuildingElementPartType() {}
...
{
	stream << "#" << m_entity_id << "= IFCBUILDINGELEMENTPARTTYPE" << "(";
...
void IfcBuildingElementPartType::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcBuildingElementPartType::toString() const { return L"IfcBuildingElementPartType"; }
void IfcBuildingElementPartType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBuildingElementPartType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
