...
IfcElectricGeneratorType::IfcElectricGeneratorType( int id ) { m_entity_id = id; }
IfcElectricGeneratorType::~IfcElectricGeneratorType() {}
...
{
	stream << "#" << m_entity_id << "= IFCELECTRICGENERATORTYPE" << "(";
...
void IfcElectricGeneratorType::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcElectricGeneratorType::toString() const { return L"IfcElectricGeneratorType"; }
void IfcElectricGeneratorType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcElectricGeneratorType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcElectricGeneratorTypeEnum::createObjectFromSTEP( args[9], map );
}
