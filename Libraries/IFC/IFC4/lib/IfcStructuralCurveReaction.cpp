...
IfcStructuralCurveReaction::IfcStructuralCurveReaction( int id ) { m_entity_id = id; }
IfcStructuralCurveReaction::~IfcStructuralCurveReaction() {}
...
{
	stream << "#" << m_entity_id << "= IFCSTRUCTURALCURVEREACTION" << "(";
...
void IfcStructuralCurveReaction::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcStructuralCurveReaction::toString() const { return L"IfcStructuralCurveReaction"; }
void IfcStructuralCurveReaction::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStructuralCurveReaction, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcStructuralCurveActivityTypeEnum::createObjectFromSTEP( args[9], map );
}
