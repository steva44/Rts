...
IfcBuildingElementProxyType::IfcBuildingElementProxyType( int id ) { m_entity_id = id; }
IfcBuildingElementProxyType::~IfcBuildingElementProxyType() {}
...
{
	stream << "#" << m_entity_id << "= IFCBUILDINGELEMENTPROXYTYPE" << "(";
...
void IfcBuildingElementProxyType::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcBuildingElementProxyType::toString() const { return L"IfcBuildingElementProxyType"; }
void IfcBuildingElementProxyType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBuildingElementProxyType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcBuildingElementProxyTypeEnum::createObjectFromSTEP( args[9], map );
}
