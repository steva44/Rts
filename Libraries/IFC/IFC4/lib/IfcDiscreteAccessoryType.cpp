...
IfcDiscreteAccessoryType::IfcDiscreteAccessoryType( int id ) { m_entity_id = id; }
IfcDiscreteAccessoryType::~IfcDiscreteAccessoryType() {}
...
{
	stream << "#" << m_entity_id << "= IFCDISCRETEACCESSORYTYPE" << "(";
...
void IfcDiscreteAccessoryType::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcDiscreteAccessoryType::toString() const { return L"IfcDiscreteAccessoryType"; }
void IfcDiscreteAccessoryType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDiscreteAccessoryType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw IfcPPException( err.str().c_str() ); }
