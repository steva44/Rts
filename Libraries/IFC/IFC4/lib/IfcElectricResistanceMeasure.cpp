...
shared_ptr<IfcElectricResistanceMeasure> IfcElectricResistanceMeasure::createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
