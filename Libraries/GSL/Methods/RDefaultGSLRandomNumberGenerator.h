#ifndef RDefaultGSLRandomNumberGenerator_H
#define RDefaultGSLRandomNumberGenerator_H
/*********************************************************************
*                                                                    *
...
class RDefaultGSLRandomNumberGenerator : public RRandomNumberGenerator
{
	Q_OBJECT
    Q_PROPERTY(int Seed READ getSeed WRITE setSeed)

public:
	RDefaultGSLRandomNumberGenerator(QObject *parent, QString name);
	~RDefaultGSLRandomNumberGenerator();
