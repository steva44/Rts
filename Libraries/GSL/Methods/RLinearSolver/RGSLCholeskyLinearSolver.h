#ifndef RGSLCholeskyLinearSolver_H
#define RGSLCholeskyLinearSolver_H
/*********************************************************************
*                                                                    *
...
class RGSLCholeskyLinearSolver : public RLinearSolver
{
	Q_OBJECT

public:
    RGSLCholeskyLinearSolver(QObject *parent, QString name);
    ~RGSLCholeskyLinearSolver();
