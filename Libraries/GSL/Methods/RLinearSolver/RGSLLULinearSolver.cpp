...
RGSLLULinearSolver::RGSLLULinearSolver(QObject *parent, QString name)
...
RGSLLULinearSolver::~RGSLLULinearSolver()
{

}


QStringList RGSLLULinearSolver::getActionList()
{
...
int RGSLLULinearSolver::inverse(QVector< QVector<double> > *inputMatrix, QVector< QVector<double> > *inverse)
{
...
int RGSLLULinearSolver::solveLinearSOE(QVector< QVector<double> > *A, QVector<double> *b, QVector<double> *x)
{
...
int RGSLLULinearSolver::cholesky(QVector< QVector<double> > *inputMatrix, QVector< QVector<double> > *cholesky, QVector< QVector<double> > *inverseCholesky)
{
    // Figure out the matrix size (remember, it is square!)
    int size = inputMatrix->size();
...
int RGSLLULinearSolver::solveLinearSOE(QVector< QVector<double> > *A, QVector< QVector<double> > *B, QVector< QVector<double> > *X)
{
