...
#include "RGSLCholeskyLinearSolver.h"
#include "RDomain.h"
...
RGSLCholeskyLinearSolver::RGSLCholeskyLinearSolver(QObject *parent, QString name)
...
RGSLCholeskyLinearSolver::~RGSLCholeskyLinearSolver()
{

}


QStringList RGSLCholeskyLinearSolver::getActionList()
{
...
int RGSLCholeskyLinearSolver::inverse(QVector< QVector<double> > *inputMatrix, QVector< QVector<double> > *inverse)
{
...
int RGSLCholeskyLinearSolver::solveLinearSOE(QVector< QVector<double> > *A, QVector<double> *b, QVector<double> *x)
{
    ...
    // Solve the SOE if it is solvable; if a determinant is negative, that means it is not positive definite / symmetric
    //IE it has negative eigenvalues
    if (determinant <= 0.0) {
        qCritical() << "Error: The coefficient matrix in the SOE is singular! The determinant is: "<<determinant;
        return -1;
    }
    else {
...
int RGSLCholeskyLinearSolver::cholesky(QVector< QVector<double> > *inputMatrix, QVector< QVector<double> > *cholesky, QVector< QVector<double> > *inverseCholesky)
{
    // Figure out the matrix size (remember, it is square!)
    int size = inputMatrix->size();
...
int RGSLCholeskyLinearSolver::solveLinearSOE(QVector< QVector<double> > *A, QVector< QVector<double> > *B, QVector< QVector<double> > *X)
{
    qCritical()<<"ERROR: the abililty to solve with a right-han-side matrix is not implemented in this solver";
    return 0;
}
