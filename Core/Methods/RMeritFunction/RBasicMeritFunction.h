#ifndef RBasicMeritFunction_H
#define RBasicMeritFunction_H
/*********************************************************************
*                                                                    *
...
class RBasicMeritFunction : public RMeritFunction
{
	Q_OBJECT
...
public:
	RBasicMeritFunction(QObject *parent, QString name);
	~RBasicMeritFunction();
