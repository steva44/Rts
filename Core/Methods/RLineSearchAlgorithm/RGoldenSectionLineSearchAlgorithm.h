#ifndef RGoldenSectionLineSearchAlgorithm_H
#define RGoldenSectionLineSearchAlgorithm_H
/*********************************************************************
*                                                                    *
...
class RGoldenSectionLineSearchAlgorithm : public RLineSearchAlgorithm
{
    Q_OBJECT
...
public:
    RGoldenSectionLineSearchAlgorithm(QObject *parent, QString name);
    ~RGoldenSectionLineSearchAlgorithm();
