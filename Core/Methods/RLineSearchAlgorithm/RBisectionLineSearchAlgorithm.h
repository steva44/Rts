#ifndef RBisectionLineSearchAlgorithm_H
#define RBisectionLineSearchAlgorithm_H
/*********************************************************************
*                                                                    *
...
class RBisectionLineSearchAlgorithm : public RLineSearchAlgorithm
{
    Q_OBJECT
...
public:
    RBisectionLineSearchAlgorithm(QObject *parent, QString name);
    ~RBisectionLineSearchAlgorithm();
