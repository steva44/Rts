#ifndef RGaussJordanLinearSolver_H
#define RGaussJordanLinearSolver_H
/*********************************************************************
*                                                                    *
...
class RGaussJordanLinearSolver : public RLinearSolver
{
	Q_OBJECT

public:
    RGaussJordanLinearSolver(QObject *parent, QString name);
    ~RGaussJordanLinearSolver();
