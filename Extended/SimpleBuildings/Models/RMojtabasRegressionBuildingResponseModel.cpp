...
#include "RMojtabasRegressionBuildingResponseModel.h"
#include "RBIM.h"
...
RMojtabasRegressionBuildingResponseModel::RMojtabasRegressionBuildingResponseModel(QObject *parent, QString name)
    : RModel(parent, name)
{
...
RMojtabasRegressionBuildingResponseModel::~RMojtabasRegressionBuildingResponseModel()
{

}

QObject * RMojtabasRegressionBuildingResponseModel::getBIM() const
{
    return theBIM;
}

void RMojtabasRegressionBuildingResponseModel::setBIM(QObject *value)
{
    theBIM = qobject_cast<RBIM *>(value);
}


QObject * RMojtabasRegressionBuildingResponseModel::getSa() const
{
    return theSa;
}

void RMojtabasRegressionBuildingResponseModel::setSa(QObject *value)
{
...
int RMojtabasRegressionBuildingResponseModel::evaluateModel(RGradientType theGradientType)
{
    ...
    qCritical() << "Hey, here I think we forget to give the location and natural period to the intensity model...";
