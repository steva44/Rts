...
RPlateComponent::RPlateComponent(QObject *parent, QString &name)
    : RComponent(parent, name)
{
    ...
    thePlateType = plateType::NA;
}


RPlateComponent::~RPlateComponent()
{

}


double RPlateComponent::getVolume()
{
    return getPlanArea()*theThicknessParameter->getCurrentValue();
}


double RPlateComponent::getLength12()
{
...
double RPlateComponent::getLength23()
{
...
double RPlateComponent::getLength34()
{
...
double RPlateComponent::getLength41()
{
...
double RPlateComponent::getPlanArea()
{
...
double RPlateComponent::getDepth()
{
    // Length of vector from 1 to 2
...
double RPlateComponent::getWidth()
{
...
double RPlateComponent::getPerimeter()
{
    double length12 = this->getLength12();
    double length34 = this->getLength34();
...
void RPlateComponent::setPoint1(QObject *value)
{
...
void RPlateComponent::setPoint2(QObject *value)
{
...
void RPlateComponent::setPoint3(QObject *value)
{
...
void RPlateComponent::setPoint4(QObject *value)
{
...
void RPlateComponent::setThickness(QObject* value)
{
...
QList<RPoint*> RPlateComponent::getPointList()
{
...
void RPlateComponent::setPlateType(plateType type)
{
    thePlateType = type;
}


RPlateComponent::plateType RPlateComponent::getPlateType(void)
{
    return thePlateType;
}
