#ifndef RLognormalOccurrenceModel_H
#define RLognormalOccurrenceModel_H
/*********************************************************************
*                                                                    *
...
class RLognormalOccurrenceModel : public RModel
{
	Q_OBJECT
    ...
    Q_PROPERTY(QString PreviousOccurenceTime READ getPrevOccTime WRITE setPrevOccTime)
...
public:
    RLognormalOccurrenceModel(QObject *parent, QString name);
	~RLognormalOccurrenceModel();
    ...
    QString getPrevOccTime() const;
    void setPrevOccTime(QString value);
