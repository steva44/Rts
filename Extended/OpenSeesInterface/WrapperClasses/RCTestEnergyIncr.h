#ifndef RCTestEnergyIncr_H
#define RCTestEnergyIncr_H
/*********************************************************************
*                                                                    *
...
// Wrapper class for OpenSees CTestEnergyIncr
...
class RCTestEnergyIncr : public RConvergenceTest
{
    Q_OBJECT
...
public:
    ...
    RCTestEnergyIncr(QObject *parent, QString name);
    ~RCTestEnergyIncr();
...
protected:
    ...
    std::unique_ptr<CTestEnergyIncr> theConvergenceTest;
