...
RNewtonRaphsonEquationSolutionAlgorithm::RNewtonRaphsonEquationSolutionAlgorithm(QObject *parent, QString name)
...
RNewtonRaphsonEquationSolutionAlgorithm::~RNewtonRaphsonEquationSolutionAlgorithm()
{

}


QObject *RNewtonRaphsonEquationSolutionAlgorithm::getTheConvergenceTest() const
{
    return theConvergenceTest;
}


void RNewtonRaphsonEquationSolutionAlgorithm::setTheConvergenceTest(QObject *value)
{
...
EquiSolnAlgo* RNewtonRaphsonEquationSolutionAlgorithm::getTheEquationSolutionAlgo()
{
    ...
    if(!theEquiSolutionAlgo)
    {
        ...
        theEquiSolutionAlgo = std::make_unique<NewtonRaphson>(*theTest);
    }
